      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <aside className="max-w-4xl mx-auto mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {relatedArticles.map((article) => (
                <Link 
                  ...
                  className="group block bg-gray-50 hover:bg-gray-100 rounded-lg overflow-hidden transition-colors"
                >
                  ...
                  <div className="p-4">
                    <h3 className="font-semibold text-levigile-dark group-hover:text-levigile-blue transition-colors">
                      {article.title}
                    </h3>
                  </div>
                </Link>
          ...
          <div>
            ...
            <div className="bg-levigile-lightgray rounded-lg p-6">
              ...
              <Button 
                variant="outline" 
                className="w-full mt-6 border-levigile-blue text-levigile-blue hover:bg-levigile-blue hover:text-white"
                asChild
              >
