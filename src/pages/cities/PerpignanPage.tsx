...
const PerpignanPage: React.FC = () => {
  const cityName = "Perpignan";
  ...
  const specificitesItems: SpecificiteItem[] = [
    ...
    },
    {
      ...
      description: "Services de gardiennage pour entreprises et particuliers à Perpignan"
    },
    {
      icon: Calendar,
      title: "Sécurité événementielle",
      description: `Organisation d'événements sécurisés à ${cityName} et dans les Pyrénées-Orientales`
    },
    {
      icon: Users,
      title: "Intervention rapide",
      description: "Équipe d'intervention disponible 24h/24 et 7j/7 sur tout le secteur de Perpignan"
    }
  ];
