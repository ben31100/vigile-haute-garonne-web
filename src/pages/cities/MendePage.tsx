...
const MendePage: React.FC = () => {
  const cityName = "Mende";
  const postalCode = "48000";
  const subtitle = "Services de sécurité et gardiennage professionnels à Mende";
  ...
  const faqItems = [
    ...
    {
      question: `Vos agents sont-ils formés aux spécificités de ${cityName} ?`,
