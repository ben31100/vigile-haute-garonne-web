...
const LozerePage: React.FC = () => {
  ...
  const specificitesItems: SpecificiteItem[] = [
    {
      ...
      description: `Surveillance des quartiers résidentiels dans tout le département de la ${departmentName}`
    },
    {
      icon: Building,
    ...
    },
    {
      ...
      description: `Organisation d'événements sécurisés en ${departmentName}`
    },
    {
      icon: Users,
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Helmet>
        <title>Sécurité en {departmentName} - Protection professionnelle | LeVigile</title>
        <meta name="description" content={`Services de sécurité en ${departmentName}. Protection et surveillance adaptées aux besoins des professionnels et particuliers.`} />
      </Helmet>
      ...
      <main className="flex-grow pt-24">
        <CityHero 
          ...
          subtitle={`Services de sécurité privée professionnels en ${departmentName} (${postalCode})`}
        ...
        <SpecificitesSection 
          ...
          title={`Pourquoi choisir LeVigile en ${departmentName} ?`}
