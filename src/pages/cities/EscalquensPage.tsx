...
const EscalquensPage: React.FC = () => {
  const cityName = "Escalquens";
  const postalCode = "31750";
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-12">
              ...
              <p className="text-lg text-gray-700">
                Services de sécurité professionnels adaptés aux besoins locaux d'{cityName}.
              </p>
            </div>
          </div>
        </section>
